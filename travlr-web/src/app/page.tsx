  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 lg:gap-12 mt-8">
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Generate an organized day-by-day plan, then keep activities and locations together in one itinerary.
                </CardDescription>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardTitle>Shared Trip Planning</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription>
                  Invite other Travlr users to view and contribute to a shared trip plan.
                </CardDescription>
              </CardContent>
            </Card>
            <Card>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} Travlr. All rights reserved.</p>
      </footer>
    </div>
  )
}
